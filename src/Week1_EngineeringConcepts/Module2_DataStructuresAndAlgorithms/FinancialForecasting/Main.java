package Week1_EngineeringConcepts.Module2_DataStructuresAndAlgorithms.FinancialForecasting;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Future value after "+years+" years : Rs."+String.format("%.2f",predictedVal));
    }
}
